...
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_12, "invalid enum value: ", 20);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_16, "\015\012", 2);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_17, "invalid format string", 21);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_18, "invalid float: ", 15);
...
appendString(T9_, ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_12));
appendString(T9_, s);
...
N_NIMCALL(NIM_CHAR, nsuToUpperAsciiChar)(NIM_CHAR c) {
	...
	nimln_(232, "strutils.nim");
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_14 = subInt(((NI) (((NU8)(c)))), ((NI) 32));
...
N_NIMCALL(NimStringDesc*, nsuToUpperAsciiStr)(NimStringDesc* s) {
	...
	result = mnewString(((NI)chckRange((s ? s->Sup.len : 0), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_13 = subInt((s ? s->Sup.len : 0), ((NI) 1));
		colontmp_ = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_13);
		nimln_(1986, "system.nim");
		res = ((NI) 0);
		{
			nimln_(1987, "system.nim");
			while (1) {
				...
				nimln_(1989, "system.nim");
				TM_JGc9b9bh2D3nTdUR7TGyq8aA_15 = addInt(res, ((NI) 1));
				res = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_15);
			} LA3: ;
		}
	}
	popFrame();
...
appendString(result, ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_16));
				}
				LA8_: ;
				{
					NI j;
...
N_NOINLINE(void, invalidFormatString_61EJWW6vRISEo9a8gt0tusw)(void) {
	...
	(*e).Sup.Sup.m_type = (&NTI_Gi06FkNeykJn7mrqRZYrkA_);
	T1_ = (NimStringDesc*)0;
	T1_ = (*e).Sup.message; (*e).Sup.message = copyStringRC1(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_17));
...
appendString(T7_, ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_18));
appendString(T7_, s);
		asgnRefNoCycle((void**) (&(*e).Sup.message), T7_);
		asgnRef((void**) (&(*e).Sup.parent), NIM_NIL);
		raiseException((Exception*)e, "ValueError");
